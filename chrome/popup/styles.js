...
export const onOffSwitchStyles = css`
    ...
    @media (prefers-color-scheme: dark) { 
        ...
        form.style.backgroundColor = "#ffffff"; // Ensure the form background color is white
    form.style.border = "1px solid #ddd"; // Add a border to see the form clearly
    form.style.padding = "20px"; // Ensure padding to avoid cramped content
